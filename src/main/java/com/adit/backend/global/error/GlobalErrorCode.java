...
public enum GlobalErrorCode implements ErrorCode {
	...
	/********************************** Global Domain **********************************/
	BAD_REQUEST_ERROR(HttpStatus.BAD_REQUEST, "GBL-001", "잘못된 요청입니다."),
	REQUEST_BODY_MISSING_ERROR(HttpStatus.BAD_REQUEST, "GBL-002", "필수 요청 본문이 누락되었습니다."),
	INVALID_TYPE_VALUE(HttpStatus.BAD_REQUEST, "GBL-003", "유효하지 않은 타입 값입니다."),
	MISSING_REQUEST_PARAMETER_ERROR(HttpStatus.BAD_REQUEST, "GBL-004", "요청 파라미터가 누락되었습니다."),
	IO_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "GBL-005", "입출력 처리 중 오류가 발생했습니다."),
	FORBIDDEN_ERROR(HttpStatus.FORBIDDEN, "GBL-006", "권한이 없습니다."),
	NOT_FOUND_ERROR(HttpStatus.NOT_FOUND, "GBL-007", "요청한 리소스를 찾을 수 없습니다."),
	NULL_POINT_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "GBL-008", "서버 처리 중 Null Pointer Exception이 발생했습니다."),
	NOT_VALID_ERROR(HttpStatus.BAD_REQUEST, "GBL-009", "유효성 검사에 실패했습니다."),
	NOT_VALID_HEADER_ERROR(HttpStatus.BAD_REQUEST, "GBL-010", "헤더 데이터가 유효하지 않습니다."),
	...
	/********************************** Auth Domain **********************************/
	ILLEGAL_REGISTRATION_ID(HttpStatus.BAD_REQUEST, "AUTH-001", "잘못된 등록 ID입니다."),
	ACCESS_TOKEN_EXPIRED(HttpStatus.UNAUTHORIZED, "AUTH-002", "토큰이 만료되었습니다."),
	INVALID_TOKEN(HttpStatus.UNAUTHORIZED, "AUTH-003", "올바르지 않은 토큰입니다."),
	INVALID_JWT_SIGNATURE(HttpStatus.UNAUTHORIZED, "AUTH-004", "잘못된 JWT 시그니처입니다."),
	TOKEN_NOT_FOUND(HttpStatus.UNAUTHORIZED, "AUTH-005", "토큰을 찾지 못했습니다."),
	TOKEN_ALREADY_EXIST(HttpStatus.CONFLICT, "AUTH-006", "토큰이 이미 생성되었습니다."),
	...
	PLATFORM_NOT_SUPPORTED(HttpStatus.BAD_REQUEST, "CRW-002", "지원하지 않는 플랫폼입니다."),
	...
	CONTENT_EMPTY(HttpStatus.MULTI_STATUS, "CRW-005", "크롤링된 컨텐츠가 비어있습니다"),
	IMAGE_EXTRACTION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "CRW-006", "이미지 추출에 실패했습니다"),
	TITLE_EXTRACTION_FAILED(HttpStatus.BAD_REQUEST, "CRW-007", "제목 추출에 실패했습니다"),
	BODY_EXTRACTION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "CRW-008", "본문 추출에 실패했습니다"),
	TEXT_PREPROCESSING_FAILED(HttpStatus.BAD_REQUEST, "CRW-009", "텍스트 전처리에 실패했습니다"),
	CONTENT_NOT_FOUND(HttpStatus.NOT_FOUND, "CRW-010", "본문 컨텐츠를 찾을 수 없습니다"),
	TISTORY_PARSING_FAILED(HttpStatus.BAD_REQUEST, "CRW-011", "티스토리 파싱에 실패했습니다"),
	SKIN_SELECTOR_NOT_FOUND(HttpStatus.NOT_FOUND, "CRW-012", "적절한 스킨 선택자를 찾을 수 없습니다"),
	...
	INSTAGRAM_PARSING_FAILED(HttpStatus.BAD_REQUEST, "CRW-015", "인스타그램 파싱에 실패했습니다"),
	INSTAGRAM_API_CONNECTION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "CRW-016", "인스타그램 API 연결에 실패했습니다"),
	INSTAGRAM_DATASET_NOT_FOUND(HttpStatus.NOT_FOUND, "CRW-017", "인스타그램 데이터셋을 찾을 수 없습니다"),
	INSTAGRAM_CONTENT_EMPTY(HttpStatus.MULTI_STATUS, "CRW-018", "인스타그램 컨텐츠가 비어있습니다"),
	INSTAGRAM_IMAGE_NOT_FOUND(HttpStatus.NOT_FOUND, "CRW-019", "인스타그램 이미지를 찾을 수 없습니다"),

	/********************************** Scraper Domain **********************************/
	SCRAPER_API_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "SCR-001", "API 호출을 실패했습니다"),
	FIELD_NOT_FOUND(HttpStatus.NOT_FOUND, "SCR-002", "해당 필드를 찾지 못했습니다"),

	/********************************** Place Domain **********************************/
	COMMON_PLACE_NOT_FOUND(HttpStatus.NOT_FOUND, "PLC-001", "해당 Common Place 를 찾지 못했습니다"),
	USER_PLACE_NOT_FOUND(HttpStatus.NOT_FOUND, "PLC-002", "해당 User Place 를 찾지 못했습니다"),
	...
	EVENT_ALREADY_EXISTS(HttpStatus.BAD_REQUEST, "EVN-002", "이미 존재하는 이벤트입니다."),
